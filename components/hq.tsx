  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto w-full">
        ...
        <div className="font-serif text-xs md:text-sm lg:mb-2">
          ...
          <div className="md:block hidden">
            ...
            {!isExpanded && (
              <button
                ...
                className={`${linkMutedClass} ml-1  text-[#EBEFF4] font-bold`}
            ...
            {isExpanded && (
              <>
                ...
                <button
                  ...
                  className={`${linkMutedClass} text-[#EBEFF4] font-bold`}
        ...
        <div className="font-serif flex flex-wrap items-center gap-x-4 gap-y-2 pt-4 mb-15" >
