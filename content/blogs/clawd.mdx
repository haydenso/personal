...
- **other tips.**
  ...
  - **git worktrees**. [claude guide](https://code.claude.com/docs/en/common-workflows) is a good starting point for how the claude code team uses claude code themselves and what works for them.    
