...
desc: little automations for my website
---
I actually wrote (or spoke) most of this by speech-to-text to my mac via [Handy](https://handy.computer/) (local inference, using Parakeet V3) with some light editing. (I realise I say a lot of ’sort ofs’ and ‘you knows')
