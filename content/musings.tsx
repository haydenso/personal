...
export const musings: Musing[] = [
  ...
  },
  {
    ...
    "pinned": false,
    "category": "software",
    "content": "<p>engineering blogs in the works:</p>\n<ul><li>revamping my personal website and building a personal CMS editor</li><li>building my bespoke people searcher (deciding it to name it holmes or doug)</li><li>apple script and bespoke trinkets</li><li>mahjong + reinforcement learning and evals for various LLMs playing mahjong.</li></ul>"
  },
  {
    "slug": "rollups",
